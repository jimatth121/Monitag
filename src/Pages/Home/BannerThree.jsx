  ...
  return (
    <div>
      <div className="relative">
        <div className="   md:px-0 absolute  flex justify-end    z-50 left-[1%] top-[8%] md:top-[70%] md:left-[65%]  items-end">
          <div className="max-w-[356px] w-full   p-5   ">
            <p className="header-1 md:leading-[60px] text-white">Send Money</p>
