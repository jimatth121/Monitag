      ...
      <div className="   md:px-0 absolute  flex justify-end    z-50 left-[1%] top-[12%] md:top-[53%] md:left-[10%]  items-end">
          <div className="max-w-[606px] w-full   p-5   ">
            ...
            <p className=" text-white text-[18px] md:leading-[30px] text-20 font-PoppinsLight">
              Pay bills and shop online with the <br /> Monitag virtual or physical
              debit <br /> card.
            </p>
            <button className="mt-5 py-2 md:py-3 bg-[rgba(255,255,255,0.4)] px-4 md:px-6 border-white border-[1px] rounded-3xl flex items-center text-white gap-3">
              Get the app now
